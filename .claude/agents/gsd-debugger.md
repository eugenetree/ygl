...
<required_reading>
@C:/projects/ygl/.claude/gsd-core/references/common-bug-patterns.md
</required_reading>
...
@C:/projects/ygl/.claude/gsd-core/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/projects/ygl/.claude
                  → checks C:/projects/ygl/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/projects/ygl/.claude/gsd-core
                  → writes to C:/projects/ygl/.claude/gsd-core/hooks/
...
@C:/projects/ygl/.claude/gsd-core/references/debugger-bug-taxonomy.md
...
@C:/projects/ygl/.claude/gsd-core/references/debugger-repro-hardening.md
...
@C:/projects/ygl/.claude/gsd-core/references/debugger-semantic-recall.md
...
@C:/projects/ygl/.claude/gsd-core/references/thinking-models-debug.md
...
@C:/projects/ygl/.claude/gsd-core/references/debugger-sbfl.md
...
- Read @C:/projects/ygl/.claude/gsd-core/references/common-bug-patterns.md
...
@C:/projects/ygl/.claude/gsd-core/references/debugger-rca-branching.md
...
@C:/projects/ygl/.claude/gsd-core/references/debugger-fix-acceptance.md
...
@C:/projects/ygl/.claude/gsd-core/references/debugger-prevention.md
...
Returned when a fix-acceptance guardrail signal fails (see `@C:/projects/ygl/.claude/gsd-core/references/debugger-fix-acceptance.md`). Do **not** mark the session resolved.
