...
<reference>
@C:/projects/ygl/.claude/gsd-core/references/user-profiling.md
...
Read the user-profiling reference document at `C:/projects/ygl/.claude/gsd-core/references/user-profiling.md` to load:
