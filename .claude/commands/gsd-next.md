...
<execution_context>
@C:/projects/ygl/.claude/gsd-core/workflows/smart-entry.md
...
<process>
Follow C:/projects/ygl/.claude/gsd-core/workflows/smart-entry.md. Detect the situation, present the menu, and dispatch exactly one command. Then stop.
</process>
