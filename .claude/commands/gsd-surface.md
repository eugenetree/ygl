...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `C:/projects/ygl/.claude/.gsd-surface.json`
(sibling to `C:/projects/ygl/.claude/.gsd-profile`) and re-stages the active skills directory in place.
Skill dirs live at `C:/projects/ygl/.claude/skills/gsd-*/`.
...
(`~/.claude`), NOT the skills sub-directory (`C:/projects/ygl/.claude/skills`).
...
`C:/projects/ygl/.claude/skills/gsd-*/` because the `claude global` layout has `destSubpath =
...
(i.e. `C:/projects/ygl/.claude/.gsd-surface.json`).
...
<execution_context>
Surface state file: `C:/projects/ygl/.claude/.gsd-surface.json`
Install profile marker: `C:/projects/ygl/.claude/.gsd-profile`
Skill dirs: `C:/projects/ygl/.claude/skills/gsd-*/`
Engine module: `C:/projects/ygl/.claude/gsd-core/bin/lib/surface.cjs`
Cluster definitions: `C:/projects/ygl/.claude/gsd-core/bin/lib/clusters.cjs`
</execution_context>
