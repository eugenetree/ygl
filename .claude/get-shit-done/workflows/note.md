...
- **Global scope**: `/Users/eugene/projects/yg/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/eugene/projects/yg/.claude/notes/`)
...
2. Glob `/Users/eugene/projects/yg/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/eugene/projects/yg/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/eugene/projects/yg/.claude/notes/` — works in any directory
