...
Key references:
- @C:/projects/ygl/.claude/gsd-core/references/ui-brand.md (display patterns)
- @C:/projects/ygl/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @C:/projects/ygl/.claude/gsd-core/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="C:/projects/ygl/.claude/gsd-core/USER-PROFILE.md"
...
```bash
cp "C:/projects/ygl/.claude/gsd-core/USER-PROFILE.md" "C:/projects/ygl/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at C:/projects/ygl/.claude/gsd-core/USER-PROFILE.md
...
- The user-profiling reference doc at `C:/projects/ygl/.claude/gsd-core/references/user-profiling.md`
...
Reference: @C:/projects/ygl/.claude/gsd-core/references/user-profiling.md
...
Display: "✓ Profile written to C:/projects/ygl/.claude/gsd-core/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to C:/projects/ygl/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at C:/projects/ygl/.claude/gsd-core/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at C:/projects/ygl/.claude/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to C:/projects/ygl/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="C:/projects/ygl/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    C:/projects/ygl/.claude/gsd-core/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   C:/projects/ygl/.claude/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       <resolved claude_md_path, default ./.claude/CLAUDE.md>
  ✓ Global CLAUDE.md        C:/projects/ygl/.claude/CLAUDE.md
```
