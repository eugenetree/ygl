...
```
Agent(
  prompt="Read C:/projects/ygl/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/projects/ygl/.claude/gsd-core/templates/SECURITY.md`
