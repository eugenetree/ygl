...
ones). Reference: @C:/projects/ygl/.claude/gsd-core/references/edge-probe.md.
...
# — NOT the consuming project's git root — falling back to git toplevel / C:/projects/ygl/.claude.
...
EDGE_PROBE_JS=$(for _c in \
  ...
  "C:/projects/ygl/.claude/gsd-core/bin/lib/edge-probe.cjs" \
  "C:/projects/ygl/.claude/bin/lib/edge-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
...
requirement list). Reference: @C:/projects/ygl/.claude/gsd-core/references/prohibition-probe.md — the
...
Use the SPEC.md template from @C:/projects/ygl/.claude/gsd-core/templates/spec.md.
