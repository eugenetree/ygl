...
```markdown
Read C:/projects/ygl/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/projects/ygl/.claude/gsd-core/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/projects/ygl/.claude/agents/gsd-ui-checker.md for instructions.
...
@C:/projects/ygl/.claude/gsd-core/references/ui-consideration-probe.md.
...
# (#448) — NOT the consuming project's git root — falling back to git toplevel / C:/projects/ygl/.claude.
...
UI_PROBE_JS=$(for _c in \
  ...
  "C:/projects/ygl/.claude/gsd-core/bin/lib/ui-consideration-probe.cjs" \
  "C:/projects/ygl/.claude/bin/lib/ui-consideration-probe.cjs"; do
  [ -f "$_c" ] && { echo "$_c"; break; }
done)
