...
import { TelegramNotificationService } from "../../_common/telegram/telegram-notification.service.js";
...
function createMocks() {
  return {
    ...
    telegramNotificationService: {
      sendMessage: mock.fn<TelegramNotificationService["sendMessage"]>(),
    },
  };
}
...
function buildSut(mocks: ReturnType<typeof createMocks>) {
  return new ProcessScraperFailureUseCase(
    ...
    mocks.telegramNotificationService as unknown as TelegramNotificationService,
  );
}
