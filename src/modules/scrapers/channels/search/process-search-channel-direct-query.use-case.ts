...
import { SearchChannelDirectQueriesRepository } from "./search-channel-direct-queries.repository.js";
import { ChannelDiscoveryDirectService } from "./channel-discovery-direct.service.js";
import { BaseError } from "../../../_common/errors.js";

@injectable()
export class ProcessSearchChannelDirectQueryUseCase {
  constructor(
    private readonly queriesRepository: SearchChannelDirectQueriesRepository,
    private readonly channelDiscoveryService: ChannelDiscoveryDirectService,
    private readonly logger: Logger,
  ) {
    this.logger.setContext(ProcessSearchChannelDirectQueryUseCase.name);
  }
