...
export class YoutubeApiGetChannelVideoEntriesOld {
  private logger = new Logger({
    context: YoutubeApiGetChannelVideoEntriesOld.name,
  });
...
export const youtubeApiGetChannelVideoEntriesOld =
  new YoutubeApiGetChannelVideoEntriesOld();
