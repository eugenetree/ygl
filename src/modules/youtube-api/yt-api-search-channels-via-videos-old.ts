...
import { searchChannelsViaVideosExtractorOld } from "./extractors/search-channels-via-videos-old.extractor.js";
...
export class YoutubeApiSearchChannelsViaVideosOld {
  ...
  private async searchChannelsInitial(query: string) {
    ...
    const channelsResult = searchChannelsViaVideosExtractorOld.extractFromHtml(
  ...
  private async searchChannelsContinuation(token: string) {
    ...
    const channelsResult = searchChannelsViaVideosExtractorOld.extractFromJson(
      responseResult.value,
    );
